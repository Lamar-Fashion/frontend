  ...
  const deleteItem = async (item) => {
    try {
      ...
      error?.response?.data?.error
        ...
        : setError("Error while delete favourite");
  ...
  return (
    <>
      <section className="fav-item">
        ...
        {!isLoading && !favArray.length && (
          <div className="empty-state-wishlist">Your wishlist is empty!</div>
        )}
